const jsonData = [
    {
        "imageSrc": "https://www.youtube.com/embed/yagbNj8xNFI",
        "ribbonText": "Free",
        "badges": [
    ...
    {
        "imageSrc": "https://www.youtube.com/embed/Viui3LuooLI",
        "badges": [
...
for (const data of jsonData) {
    ...
    <iframe width="670" height="320" class="card-img-top" src="${data.imageSrc}" title="Comment créer une Entreprise individuelle au Sénégal" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
